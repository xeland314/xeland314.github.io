  ...
  return (
    <div className="p-6">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          Se define un <code>struct</code> base llamado <code>Class</code>. A partir de este se pueden crear más objetos que hereden los mismos atributos y métodos. El diseño permite reutilizar y gestionar atributos de manera eficiente.
        </p>
...
char * toString(const void * self);`}
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          El manejo de objetos permite simplificar la gestión de memoria en C. Considera el ejemplo de inicializar una cadena usando la clase <code>String</code>:
        </p>
        <pre className="p-4 rounded-md">
          {`#include "String.h"
#include <stdlib.h>
...
int main() {
    ...
    return 0;
      ...
      <section className="mb-8">
        <h2 className="text-3xl font-semibold mb-4">🔹 Funciones principales</h2>
        <ul className="list-disc pl-6 space-y-4">
          <li>
            <strong>Constructor:</strong> Inicializa cualquier objeto de forma estandarizada con <code>new()</code>. Por ejemplo:
          ...
          <li>
            <strong>toString:</strong> Retorna el contenido del objeto como una cadena imprimible:
      ...
      <section className="mb-8">
        ...
        <p className="mt-4">
          Los tests utilizan la librería <a href="https://github.com/mity/acutest" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">acutest.h</a>. Esto permite agregar más funcionalidades y probarlas.
        </p>
      </section>
