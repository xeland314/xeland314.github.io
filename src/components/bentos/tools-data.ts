...
export const TOOLS: ToolCard[] = [
  ...
  {
    href: "/recortar-pdf",
    title: { es: "Recortar PDF", en: "Crop PDF" },
    description: {
      es: "Borra, extrae y recorta páginas offline",
      en: "Delete, extract & crop pages offline",
    },
    badge: { es: "PDF", en: "PDF" },
  ...
  },
  {
    ...
    description: {
      es: "Marca +10 puntos sin límite con íconos",
      en: "Pin 10+ places with custom icons",
    },
    badge: { es: "Nuevo", en: "New" },
