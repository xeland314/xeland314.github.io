      ...
      <div className="w-full lg:w-80 space-y-6 bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-xl h-fit sticky top-4">
        ...
        <div className="space-y-4 text-sm">
          ...
          <div className="grid grid-cols-2 gap-4">
              <div>
                  <label className="block mb-1 font-bold">Blur ({bgBlur}px)</label>
                  <input type="range" min="0" max="20" value={bgBlur} onChange={(e) => setBgBlur(Number(e.target.value))} className="w-full" />
              </div>
              <div>
                  <label className="block mb-1 font-bold">Opacidad ({bgOpacity}%)</label>
                  <input type="range" min="0" max="100" value={bgOpacity} onChange={(e) => setBgOpacity(Number(e.target.value))} className="w-full" />
              </div>
          </div>

          <div>
              <label className="block mb-1 font-bold">Tamaño Fuente ({fontSize}px)</label>            <input type="range" min="12" max="64" value={fontSize} onChange={(e) => setFontSize(Number(e.target.value))} className="w-full" />
          </div>
          ...
          {bgType === 'color' ? (
            ...
            <div>
              ...
              <input type="file" accept="image/*" onChange={handleBgUpload} className="p-2 rounded-md w-full text-xs bg-gray-100 dark:bg-gray-600 hover:bg-blue-500" />
            </div>
          )}
