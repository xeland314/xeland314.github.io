      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-2">
          <select
            ...
            className="w-full bg-gray-50 dark:bg-gray-700 p-2 rounded border border-gray-300 dark:border-gray-600 outline-none"
          >
      ...
      <div className="space-y-2">
        <div>
          ...
          <div className="flex gap-2">
            ...
            />
            <input
              id="plain-text-color-text"
              type="text"
              value={plainTextColor}
              onChange={(e) => setPlainTextColor(e.target.value)}
              className="flex-1 bg-gray-50 dark:bg-gray-700 px-2 rounded border border-gray-300 dark:border-gray-600 text-xs font-mono"
            />
          </div>
        </div>
        <div>
          <label
            htmlFor="plain-bg-color"
            className="block mb-1 font-bold text-xs uppercase opacity-50"
          >
            Color Fondo
          </label>
          <div className="flex gap-2">
            <input
              ...
              type="color"
              value={plainBgColor}
              onChange={(e) => setPlainBgColor(e.target.value)}
              className="w-8 h-8 rounded border-none cursor-pointer"
            />
            <input
              id="plain-bg-color-text"
              type="text"
              value={plainBgColor}
              onChange={(e) => setPlainBgColor(e.target.value)}
              className="flex-1 bg-gray-50 dark:bg-gray-700 px-2 rounded border border-gray-300 dark:border-gray-600 text-xs font-mono"
