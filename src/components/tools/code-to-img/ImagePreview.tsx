...
export const ImagePreview: React.FC<Props> = ({
  exportRef, width, height, bgType, bgColor, bgImage, bgBlur, bgOpacity, padding,
  code, language, themeName, fontSize, showLineNumbers,
  showFooter, showLogo, showUsername, username
}) => {
  return (
