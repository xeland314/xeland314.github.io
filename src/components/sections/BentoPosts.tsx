  ...
  return (
    <div className="relative h-full flex flex-col bg-white dark:bg-gray-800 rounded-3xl overflow-hidden border border-gray-100 dark:border-gray-700 shadow-sm group">
      ...
      <div className="relative h-64 overflow-hidden bg-gray-100 dark:bg-gray-900">
        <img src={post.image} alt={post.title} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" width={"256"} height={"256"} fetchPriority="high" />
      ...
      <div className="p-4 flex flex-col flex-grow justify-between">
        <div className="flex items-center justify-between mt-auto">
          <a href={post.url} className="px-3 text-[11px] uppercase tracking-widest font-bold text-blue-600 dark:text-blue-400 hover:underline">
