  ...
  return (
    ...
    <div ref={menuWrapperRef} className="flex">
      ...
      <ul
        ...
        className={`absolute z-1000 top-full right-0 items-center max-md:w-full bg-gray-900 md:px-4 list-none overflow-hidden md:static md:flex md:flex-row md:space-x-4 transition-all duration-300 ease-in-out ${
